...
var TreeNode = function TreeNode(_ref) {
  ...
  }, data.values.length > 0 && React.createElement("div", {
    id: "toggle_" + data.label.replaceAll(" ", "_"),
    onClick: handleToggle
  }, expanded ? React.createElement(reactFontawesome.FontAwesomeIcon, {
    icon: freeSolidSvgIcons.faMinusCircle,
    color: expandIconColor
  }) : React.createElement(reactFontawesome.FontAwesomeIcon, {
    icon: freeSolidSvgIcons.faPlusCircle,
  ...
  }), React.createElement("div", null, data.label))), expanded && React.createElement("div", null, data.values.length > 0 ? data.values.map(function (child, index) {
...
var TreeView = function TreeView(_ref) {
  ...
  var _React$useState = React.useState(_extends({}, data, {
      isChecked: false
    })),
  ...
  return React.createElement("div", null, React.createElement(TreeNode, {
    key: -1,
    data: treeData,
    handleCheckboxClick: handleCheckboxClick,
    checkboxScale: checkboxScale,
    ...
    selectedItemClass: selectedItemClass,
    itemClass: itemClass
  }), showSelection && React.createElement("div", null, React.createElement("ul", null, getSelectedItems(treeData, '', []).map(function (selectedItem, index) {
